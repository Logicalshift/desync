...
impl<T: 'static+Send> Desync<T> {
    ...
    ///
    pub fn after<'a, TFn, Item: 'static+Send, Error: 'static+Send, Res: 'static+Send, Fut: 'a+Future<Item=Item, Error=Error>+Send>(&self, after: Fut, job: TFn) -> impl 'a+Future<Item=Res, Error=Error>+Send 
